 ...
 * @author duopan
 */
public class OneUserInfoFrame extends javax.swing.JFrame
{
    ...
    {
        User u = BankSystem.getInstance().getCurrUser();
    ...
    {//GEN-HEADEREND:event_jButtonSaveActionPerformed
        ...
        BankSystem.getInstance().getCurrUser().setEmail(jTextFieldEmail.getText());
        BankSystem.getInstance().getCurrUser().setAddress(jTextFieldAddress.getText());
        BankSystem.getInstance().getCurrUser().setFirstName(jTextFieldFN.getText());
        BankSystem.getInstance().getCurrUser().setLastName(jTextFieldLN.getText());
        BankSystem.getInstance().getCurrUser().setPassword(jTextFieldPsw.getText());
        BankSystem.getInstance().getCurrUser().setPhone(jTextFieldPhone.getText());
        BankSystem.getInstance().getCurrUser().setType(jComboBoxType.getSelectedItem().toString());
        
        BankSystem.getInstance().updateInfo(1);
        
        JOptionPane.showMessageDialog(null, "Edit Successfully!", "Waring", JOptionPane.INFORMATION_MESSAGE);
